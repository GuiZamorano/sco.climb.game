...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	RepositoryManager getRepositoryManager() throws UnknownHostException, MongoException, StorageException, ParseException {
		...
		PedibusTeam pedibusTeam = new PedibusTeam("Smart Lab", "1",
		...
		PedibusPlayer player1 = new PedibusPlayer("550074872781", "Student", "1", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player1, "123", true);
		PedibusPlayer player2 = new PedibusPlayer("5500072EE69A", "Student", "2", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player2, "123", true);
		PedibusPlayer player3 = new PedibusPlayer("5500074F3528", "Student", "3", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player3, "123", true);
		PedibusPlayer player4 = new PedibusPlayer("55000767596C", "Student", "4", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player4, "123", true);
		PedibusPlayer player5 = new PedibusPlayer("5500076DC2FD", "Student", "5", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player5, "123", true);
		PedibusPlayer player6 = new PedibusPlayer("5500078C7BA5", "Student", "6", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player6, "123", true);
		PedibusPlayer player7 = new PedibusPlayer("5500079DD916", "Student", "7", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player7, "123", true);
		PedibusPlayer player8 = new PedibusPlayer("550007CC0E90", "Student", "8", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player8, "123", true);
		PedibusPlayer player9 = new PedibusPlayer("550007D9F279", "Student", "9", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player9, "123", true);
		PedibusPlayer player10 = new PedibusPlayer("550007DF169B", "Student", "10", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player10, "123", true);
		PedibusPlayer player11 = new PedibusPlayer("550007EF9A27", "Student", "11", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player11, "123", true);
		PedibusPlayer player12 = new PedibusPlayer("550007F57ADD", "Student", "12", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player12, "123", true);
		PedibusPlayer player13 = new PedibusPlayer("550007F715B0", "Student", "13", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player13, "123", true);
		PedibusPlayer player14 = new PedibusPlayer("550007FA8A22", "Student", "14", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player14, "123", true);
		PedibusPlayer player15 = new PedibusPlayer("550008005B06", "Student", "15", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player15, "123", true);
		PedibusPlayer player16 = new PedibusPlayer("550008017A26", "Student", "16", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player16, "123", true);
		PedibusPlayer player17 = new PedibusPlayer("5500081B0345", "Student", "17", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player17, "123", true);
		PedibusPlayer player18 = new PedibusPlayer("55000820007D", "Student", "18", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player18, "123", true);
		PedibusPlayer player19 = new PedibusPlayer("55000827AED4", "Student", "19", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player19, "123", true);
		PedibusPlayer player20 = new PedibusPlayer("5500082F2557", "Student", "20", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player20, "123", true);
		PedibusPlayer player21 = new PedibusPlayer("550008325F30", "Student", "21", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player21, "123", true);
		PedibusPlayer player22 = new PedibusPlayer("55000838A0C5", "Student", "22", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player22, "123", true);
		PedibusPlayer player23 = new PedibusPlayer("55000850131E", "Student", "23", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player23, "123", true);
		PedibusPlayer player24 = new PedibusPlayer("55000864477E", "Student", "24", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player24, "123", true);
		PedibusPlayer player25 = new PedibusPlayer("55000873DFF1", "Student", "25", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player25, "123", true);
		PedibusPlayer player26 = new PedibusPlayer("550008FA10B7", "Student", "26", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player26, "123", true);
		PedibusPlayer player27 = new PedibusPlayer("5500090EDE8C", "Student", "27", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player27, "123", true);
		PedibusPlayer player28 = new PedibusPlayer("55000934E68E", "Student", "28", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player28, "123", true);
		PedibusPlayer player29 = new PedibusPlayer("550009F8BC18", "Student", "29", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player29, "123", true);
		PedibusPlayer player30 = new PedibusPlayer("55000A04B4EF", "Student", "30", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player30, "123", true);
		PedibusPlayer player31 = new PedibusPlayer("55000A149CD7", "Student", "31", "Smart Lab", "1");
		repositoryManager.savePedibusPlayer(player31, "123", true);
		PedibusPlayer player32 = new PedibusPlayer("55007486EF48", "Student", "32", "Smart Lab", "1");
