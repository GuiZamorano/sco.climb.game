...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	RepositoryManager getRepositoryManager() throws UnknownHostException, MongoException, StorageException, ParseException {
		...
		dataSetInfo.setOwnerId("123");//login
		dataSetInfo.setPassword("kidsgogreen");//password
		...
		PedibusGame pedibusGame = new PedibusGame("003658", "UT Austin", new ArrayList<String>(){{
			add("PROJECT SMART"); add("KidsGoGreen");
		...
		PedibusTeam pedibusTeam1 = new PedibusTeam("KidsGoGreen", "1", new ArrayList<String>(){{
			add("1");add("2");}}, 0.0);
		PedibusPlayer Steve = new PedibusPlayer("8", "Steve", "Bray", "KidsGoGreen", "1");
		PedibusPlayer Bob = new PedibusPlayer("9", "Bob", "Tewani", "KidsGoGreen", "1");
		...
		repositoryManager.savePedibusGame(pedibusGame, "123", true);
		repositoryManager.savePedibusTeam(pedibusTeam1, "123", true);
		repositoryManager.savePedibusPlayer(Steve, "123", true);
		repositoryManager.savePedibusPlayer(Bob, "123", true);
